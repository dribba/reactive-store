...
/***/ function(module, exports, __webpack_require__) {
	...
	var Notifier = __webpack_require__(38);
	var ReactiveContext = __webpack_require__(81);
	var Dependency = __webpack_require__(82);
	...
	module.exports = function () {
	    ...
	    that.setValue = function (key, value) {
	        ...
	        if (_.isPlainObject(value)) {
	            ...
	            return [key].concat(objectKeys(value).map(function (k) {
	        ...
	        function isArrayElement(key, value) {
	            ...
	            if (parts.length > 1 && isNaN(_.last(parts)) === false) {
	                ...
	                return _.isEmpty(keys) === false && keys.every(function (v, idx) {
	...
	module.exports = function Notifier(dict) {
	    ...
	    var that = {
	        ...
	        flush: function flush() {
	            ...
	            arrayFrom(deps).forEach(function (dep) {
	                return dep.changed();
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(28)(IteratorPrototype, __webpack_require__(52)('iterator'), function () {
	  return this;
	});
